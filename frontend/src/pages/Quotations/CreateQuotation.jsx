...
const CreateQuotation = () => {
    ...
    const [loadingQuotationNumber, setLoadingQuotationNumber] = useState(true);
    /* -------------------------------------------------------
       CLIENT DROPDOWN
    ------------------------------------------------------- */
    ...
    useEffect(() => {
        const generateQuotationNumber = async () => {
            try {
                setLoadingQuotationNumber(true);

                const response =
                    await api.quotations.nextNumber();
                ...
                if (!quotationNumber) {
                    throw new Error(
                        'Quotation number was not returned by the server.'
                    );
                }
                ...
                setLoadingQuotationNumber(false);
            }
        };
  ...
  ========================================================= */
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (companyLogo) {
                const logoResponse =
                    await api.quotations.uploadLogo(
                        createdQuotation.id,
                        companyLogo,
                        (progress) => {
                            console.log(
            ...
            success(
                `Quotation ${createdQuotation.quotation_number ||
                formData.quotationNumber
                } created successfully`
            );

            navigate(`/quotations/${createdQuotation.id}/view`);
    ...
    const handleSend = () => {
        ...
        error(
            'Quotation sending is not available yet because the backend send endpoint is not implemented.'
        );
    };
                    ...
                    <Card>
                        ...
                        <Card.Header>
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-1">
                                    Basic information shown on the Quotation.
                                </p>
                            </div>
                        </Card.Header>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <Input
                                ...
                                required
                                placeholder={
                                    loadingQuotationNumber
                                        ? 'Generating Quotation number...'
                                        : 'Quotation number'
                                }
                            />
                            <p className="text-xs text-red-400 mt-10">
                                Quotation number is generated automatically.
                            </p>
                        ...
                        <Card className="overflow-hidden">
                            ...
                            <Card.Header>
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 mt-1">
                                        Updates as you edit the quotation.
                                    </p>
                                </div>
            ...
            >
                ...
                <div className="space-y-5">
                    ...
                    <div className="rounded-xl bg-primary/5 border border-primary/10 p-4">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                            This client will be created and automatically selected for this Quotation.
                        </p>
                ...
                <div ref={previewRef} className="max-h-[calc(100vh-220px)] overflow-y-auto overscroll-contain bg-slate-100 text-black rounded-2xl p-3 sm:p-6" > <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden text-gray-900">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6 px-6 sm:px-10 pt-8 pb-7 border-b border-gray-200">
                        ...
                        <div className="text-right">
                            ...
                            <h1 className="text-3xl sm:text-4xl font-black tracking-[0.08em] text-gray-900"> QUOTATION </h1>

                            <p className="text-sm text-gray-500 mt-2"> Quotation # <span className="font-semibold text-gray-800"> {formData.quotationNumber} </span> </p>
                    ...
                    <div className="mt-10 px-6 sm:px-10 py-6 border-t border-gray-200 bg-gray-50 text-center">
                        ...
                        <p className="text-[11px] text-gray-400 mt-1"> This is a preview of your Quotation. </p>
                    </div>
                </div>
            </Modal>
        </div>
