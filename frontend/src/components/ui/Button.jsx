...
const Button = forwardRef(
  (
    ...
    const variants = {
      ...
      secondary:
        "bg-white dark:bg-dark-card text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 focus:ring-gray-200",

      danger:
        "bg-danger text-white hover:bg-red-700 focus:ring-danger",

      ghost:
        "text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:ring-gray-200",
